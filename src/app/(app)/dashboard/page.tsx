    ...
    <main className="mx-auto max-w-3xl px-6 py-10">
      <section className="mb-8 rounded-2xl border border-black/10 bg-white p-6">
        <p className="text-sm leading-relaxed text-black/65">
          <strong className="text-brand-dark">Init</strong> turns a goal, a skill level, and a time
          budget into a structured path through free resources that already exist — not another
          search results page.
        </p>
      </section>

      <section className="mb-8 rounded-2xl border-2 border-brand-dark bg-white p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <Link
            href="/wizard"
            className="rounded-lg border-2 border-brand-dark bg-brand-pink px-4 py-2.5 text-sm font-extrabold text-white shadow-[3px_3px_0_#111827] transition active:translate-x-[1px] active:translate-y-[1px] active:shadow-[2px_2px_0_#111827]"
          >
